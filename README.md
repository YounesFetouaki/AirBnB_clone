...
**Weight:** 5 | **Project Duration:**  Dec 4, 2023 4:00 AM, must end by Dec 11, 2023 4:00 AM 
**Team Members:** Younes Fetouaki , Amin El aarouchi
...
1. Clone the repository:
   ```
   git clone https://github.com/YounesFetouaki/AirBnB_clone.git
   ```
